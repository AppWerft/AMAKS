...
MAKE_SYSTEM_PROP(ACTIVITY,UIAMAKSNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIAMAKSNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIAMAKSNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIAMAKSNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIAMAKSNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIAMAKSNativeItemContactAdd);
