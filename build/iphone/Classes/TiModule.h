...
/**
 The base class for all AMAKS modules
 */
...
/**
 AMAKS Platform calls this method on startup.
 */
-(void)startup;

/**
 AMAKS Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AMAKS Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AMAKS Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AMAKS Platform calls this method on resume.
 @param sender The sender of the event.
 */
