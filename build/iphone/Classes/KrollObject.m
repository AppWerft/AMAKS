 ...
 * Copyright (c) 2009-2011 by AMAKS, Inc. All Rights Reserved.
...
//@interface AMAKSObject : NSObject
//@end

@interface AMAKSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AMAKSObject class]])
		{
			for (NSString *key in [[(AMAKSObject*)o modules] allKeys])
			{
